...
Additionally, column names like <code>ProsperRating (Alpha)</code> and <code>ListingCategory (numeric)</code> were changed to <code>ProsperRating</code> and <code>ListingCategory</c>, respectively. 
