...
The prosper loan dataset was manually downloaded and loaded as <code>prosperLoanData.csv</code> using pd.read_csv with the extension <code>".csv," and was assigned to a variable df.
