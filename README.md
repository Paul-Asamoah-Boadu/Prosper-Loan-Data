...
Additionally, column names like <code>ProsperRating (Alpha)</code> and <code>ListingCategory (numeric)</code> were changed to `ProsperRating` and `ListingCategory`, respectively. 
