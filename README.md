...
- Change datatype of <code>Term</code>, <code>LoanStatus</code>, <code>ProsperRating (Alpha)</code>, <code>BorrowerState</code>, <code>IncomeRange</code>, <cod>EmploymentStatus</> categorical.
