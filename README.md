...
Additionally, column names like <code>ProsperRating (Alpha)</code> and `ListingCategory (numeric)` were changed to `ProsperRating` and `ListingCategory`, respectively. 
